...
const MuscleChip: React.FC<{ muscle: string }> = ({ muscle }) => (
    <span className="px-2 py-0.5 bg-zinc-800 rounded-lg text-[9px] font-medium text-zinc-400 capitalize">
        {muscle}
    </span>
);
        ...
        <div className="fixed inset-0 z-50 bg-black flex flex-col pt-safe">
            ...
            <div className="flex-1 overflow-y-auto p-5 space-y-6 no-scrollbar">
                ...
                <section>
                    <div className="flex items-center justify-between mb-2">
                        ...
                        <button
                            ...
                            className="text-[9px] font-medium text-zinc-600 hover:text-brand-primary transition-colors"
                        >
                            Load example
                        </button>
                    </div>
                    ...
                    <p className="text-[9px] font-medium text-zinc-600 mt-1.5 leading-relaxed">
                ...
                <button
                    ...
                    className="w-full py-4 bg-brand-primary text-black font-bold uppercase text-xs tracking-widest flex items-center justify-center gap-2 disabled:opacity-30 disabled:grayscale transition-all rounded-lg"
                >
                    {isProcessing ? (
                                ...
                                <>
                                                    ...
                                                    <div className="flex items-start justify-between mb-2">
                                                        <div>
                                                            ...
                                                            <div className="flex items-center gap-1 mt-1 flex-wrap">
                                                                ...
                                                                <span className="text-[9px] font-medium text-zinc-600 ml-1">
                                                        ...
                                                        {isSaved ? (
                                                            ...
                                                            <button
                                                                ...
                                                                className="shrink-0 px-3 py-1.5 border border-zinc-700 text-zinc-400 text-[9px] font-bold uppercase rounded-lg hover:border-brand-primary hover:text-brand-primary transition-all"
                                                            >
                                                                Save
                                                            </button>
                                                        )}
                                    ...
                                    {!allSaved && result.days.length > 1 && (
                                        <button
                                            ...
                                            className="w-full py-4 flex items-center justify-center gap-2 bg-brand-primary text-black font-bold uppercase text-xs tracking-widest rounded-lg hover:bg-brand-accent transition-all"
                                        >
                                    ...
                                    {allSaved && (
                                        ...
                                        >
                                            ...
                                            <button
                                                onClick={onClose}
                                                className="mt-3 px-4 py-2 text-[10px] font-bold uppercase text-brand-primary border border-brand-primary/30 rounded-lg hover:bg-brand-primary/10 transition-all"
                                            >
                                                Close
                                            </button>
                                        </motion.div>
