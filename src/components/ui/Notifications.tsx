            ...
            <AnimatePresence mode="popLayout">
                {notifications.map(n => (
                    <motion.div
                        ...
                        className={`pointer-events-auto flex items-start gap-3 p-3 rounded-xl border bg-black/90 backdrop-blur-md shadow-xl ${n.type === 'error' ? 'border-red-500/50 shadow-red-950/40' :
